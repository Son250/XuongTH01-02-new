    ...
    <script src="../assets/js2/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="../assets/vendor2/datatables/jquery.dataTables.min.js"></script>
    <script src="../assets/vendor2/datatables/dataTables.bootstrap4.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../assets/js2/demo/datatables-demo.js"></script>
    ...
    <!-- Page level custom scripts -->
    <script src="../assets/js2/demo/chart-area-demo.js"></script>
    <script src="../assets/js2/demo/chart-pie-demo.js"></script>
